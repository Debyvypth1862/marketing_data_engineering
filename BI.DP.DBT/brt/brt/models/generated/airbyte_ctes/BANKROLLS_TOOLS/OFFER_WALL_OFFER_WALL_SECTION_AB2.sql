...
-- depends_on: {{ ref('OFFER_WALL_OFFER_WALL_SECTION_AB1') }}
select
    cast(OFFER_WALL_SECTION_ID as {{ dbt_utils.type_bigint() }}) as OFFER_WALL_SECTION_ID,
    case
...
from {{ ref('OFFER_WALL_OFFER_WALL_SECTION_AB1') }}
