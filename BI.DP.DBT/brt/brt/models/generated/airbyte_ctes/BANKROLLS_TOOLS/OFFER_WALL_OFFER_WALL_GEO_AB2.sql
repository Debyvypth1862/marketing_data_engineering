...
-- depends_on: {{ ref('OFFER_WALL_OFFER_WALL_GEO_AB1') }}
select
    case
    ...
    cast(OFFER_WALL_GEO_ID as {{ dbt_utils.type_bigint() }}) as OFFER_WALL_GEO_ID,
    case
...
from {{ ref('OFFER_WALL_OFFER_WALL_GEO_AB1') }}
