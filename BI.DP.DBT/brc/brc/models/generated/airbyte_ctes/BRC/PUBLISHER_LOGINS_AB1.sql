...
select
	{{ json_extract_scalar('_airbyte_data', ['logi_fk_publisher'], ['logi_fk_publisher']) }} as LOGI_FK_PUBLISHER,
	{{ json_extract_scalar('_airbyte_data', ['logi_id'], ['logi_id']) }} as LOGI_ID,
	{{ json_extract_scalar('_airbyte_data', ['logi_ip'], ['logi_ip']) }} as LOGI_IP,
	{{ json_extract_scalar('_airbyte_data', ['logi_mobile'], ['logi_mobile']) }} as LOGI_MOBILE,
...
from {{ source('BRC', '_AIRBYTE_RAW_PUBLISHER_LOGINS') }} as table_alias
where 1 = 1
