...
select
    {{ json_extract_scalar('_airbyte_data', ['active28DayUsers'], ['active28DayUsers']) }} as ACTIVE_28_DAY_USERS,
...
from {{ source('GOOGLE_ANALYTICS', '_AIRBYTE_RAW_FOUR_WEEKLY_ACTIVE_USERS') }} as table_alias
JOIN s3_status s3
