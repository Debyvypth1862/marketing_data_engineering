...
-- depends_on: {{ ref('TRAFFIC_SOURCES_AB1') }}
select
    ...
    try_cast(SESSION_MEDIUM as {{ dbt_utils.type_string() }}) as SESSION_MEDIUM,
    try_cast(SESSIONS as {{ dbt_utils.type_string() }}) as SESSIONS,
    try_cast(SESSION_SOURCE as {{ dbt_utils.type_string() }}) as SESSION_SOURCE,
