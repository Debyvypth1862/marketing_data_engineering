...
-- Base transformation for BRT_PARENT_ALL
-- Converts V_BRT_PARENT_ALL.sql to dbt model with source() references
...
(
    ...
    FROM CONSOLIDATION_BRC_OPERATOR_TEMP rev
    GROUP BY ALL
)
...
SELECT
    ...
    {{ dbt_utils.surrogate_key(['rev.Click_Date', 'rev.Parent_ID']) }} as _AIRBYTE_AB_ID
