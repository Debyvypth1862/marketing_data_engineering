...
-- Registration conversions from BRC with all joins
SELECT
    ...
    'Registration' as Conversion_Name,
    'USD' as Conversion_Currency,
    sum(Case when POST_FTD_DATE is not null then 1 else 0 end) as Conversion_Value
...
WHERE
    ...
    pstbk.POST_FTD_DATE is not null
group by all
