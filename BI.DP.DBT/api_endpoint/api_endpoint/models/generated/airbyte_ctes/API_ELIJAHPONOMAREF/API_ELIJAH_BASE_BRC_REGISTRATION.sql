...
-- BRC Registration for ElijahPonomaref
Select
    pstbk.POST_SIGNUP_DATE as Event_Date,
    ...
    sum(Case when pstbk.POST_SIGNUP_DATE is not null then 1 else 0 end) as SignUp_Cnt
...
where pstbk.POST_SIGNUP_DATE is not null
and pub.PUBL_USERNAME = 'ElijahPonomaref'
