...
-- Base model: BRC Clicks with campaign details
-- Extracts click data from BRC postback tracking with full campaign information
select
    ...
    a.CAMP_REV_OUT as RevShare_Deal,
     Case 
        ...
        as CPA_Deal,
    count(pstbk.POST_CLICKID) as Click_Cnt
