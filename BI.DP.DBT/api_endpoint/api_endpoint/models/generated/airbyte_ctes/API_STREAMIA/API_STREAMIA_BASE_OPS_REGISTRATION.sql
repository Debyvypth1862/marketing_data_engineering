...
-- Base model: Operator Registration data with campaign details
-- Extracts signup/registration data from operator aggregation
Select
    ops.SIGNUP_DATE as Event_Date,
