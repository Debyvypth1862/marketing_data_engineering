...
-- Base model: BRC Unique Clicks at CAMPAIGN level
-- Used for final join in CAMPAIGN pipeline (with campaign fields)
select
    ...
    a.CAMP_DISPLAY_DEAL as Campiagn_Deal, -- missed
