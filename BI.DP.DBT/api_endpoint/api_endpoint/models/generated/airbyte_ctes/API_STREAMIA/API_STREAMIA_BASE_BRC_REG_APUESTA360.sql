...
-- Base model: BRC Registrations for Apuesta360 (TLOG_ID = 5993)
-- Extracts registration counts specifically for Apuesta360 tracker
select
    ...
    Case 
        ...
        as CPA_Deal,
    Sum(Case when pstbk.post_signup_date is not null then 1 else 0 end) as Reg_Cnt
