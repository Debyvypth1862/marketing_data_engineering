...
-- Base model: BRC First Deposits from POSTBACK_TRACKING
-- Filtered for SEO publishers: Clovr, Lines, CasinoRoom, Esportiva
Select
    pstbk.POST_FTD_DATE as Event_Date,
...
Where pstbk.POST_FTD_DATE is not null
    and pub.PUBL_USERNAME in ('Clovr','Lines','CasinoRoom','Esportiva')
group by all
