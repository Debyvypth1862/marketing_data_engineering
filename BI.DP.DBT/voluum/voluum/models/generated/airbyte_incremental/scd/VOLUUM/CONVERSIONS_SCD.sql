...
scd_data as (
    ...
    select
      {{ dbt_utils.surrogate_key([
        ...
        USER_AGENT,
        VISIT_TIMESTAMP ,
    POSTBACK_TIMESTAMP as _AIRBYTE_START_AT,
      lag(POSTBACK_TIMESTAMP) over (
        partition by POSTBACK_TIMESTAMP, CLICKID, CONVERSION_TYPE_ID
        order by
            POSTBACK_TIMESTAMP is null asc,
            POSTBACK_TIMESTAMP desc,
