...
select 
	...
	{{ json_extract_scalar('_airbyte_data', ['landerCountry'], ['landerCountry']) }} as LANDER_COUNTRY,
	...
	{{ json_extract_scalar('_airbyte_data', ['landerUrl'], ['landerUrl']) }} as LANDER_URL,
	{{ json_extract_scalar('_airbyte_data', ['landerWorkspaceId'], ['landerWorkspaceId']) }} as LANDER_WORKSPACE_ID,
	{{ json_extract_scalar('_airbyte_data', ['landerWorkspaceName'], ['landerWorkspaceName']) }} as LANDER_WORKSPACE_NAME,
...
from {{ source('VOLUUM', '_AIRBYTE_RAW_LANDER_REPORT') }} as table_alias
JOIN s3_status s3
