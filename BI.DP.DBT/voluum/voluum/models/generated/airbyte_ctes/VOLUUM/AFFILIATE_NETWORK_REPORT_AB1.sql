...
select 
    ...
    {{ json_extract_scalar('_airbyte_data', ['affiliateNetworkWorkspaceId'], ['affiliateNetworkWorkspaceId']) }} as AFFILIATE_NETWORK_WORKSPACE_ID,
    {{ json_extract_scalar('_airbyte_data', ['affiliateNetworkWorkspaceName'], ['affiliateNetworkWorkspaceName']) }} as AFFILIATE_NETWORK_WORKSPACE_NAME,
    ...
    {{ json_extract_scalar('_airbyte_data', ['onlyWhitelistedPostbackIps'], ['onlyWhitelistedPostbackIps']) }} as ONLY_WHITELISTED_POSTBACK_IPS,
...
from {{ source('VOLUUM', '_AIRBYTE_RAW_AFFILIATE_NETWORK_REPORT') }} as table_alias
JOIN s3_status s3
