...
-- depends_on: {{ source('VOLUUM', '_AIRBYTE_RAW_CAMPAIGN_REPORT') }}
WITH s3_status AS (
...
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['offerPayoutInOriginalCurrency'], ['offerPayoutInOriginalCurrency']) }} as OFFER_PAYOUTIN_ORIGINAL_CURRENCY,
...
from {{ source('VOLUUM', '_AIRBYTE_RAW_CAMPAIGN_REPORT') }} as table_alias
JOIN s3_status s3
