...
working_dir = "/opt/airflow/dags/dbt/ga4/ga4"
task_group_and_task_ids = []
no_of_tasks = 2
dag_id = "GoogleAnalyticsDbtTriggered"
reprocess_dag_id = "ReprocessGoogleAnalyticsExecuteAllOperatorAccounts"
...
with DAG(
    ...
    start = BashOperator(
        task_id="start",
        bash_command='echo "Starting Google Analytics DBT DAG..."',
    )
    ...
    ) as google_analytics_4_dbt_group:
    ...
    start >> google_analytics_4_dbt_group >> Jira_create >> end >> branch_task
