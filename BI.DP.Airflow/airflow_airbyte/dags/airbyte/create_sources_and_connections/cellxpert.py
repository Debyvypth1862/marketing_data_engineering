...
class Cellxpert:
    source_name = Variable.get('cellxpert_sourceName'),
    source_definition_id = Variable.get('cellxpert_source_definationid')

    def __init__(self, base_url, from_date, api_password, api_username, tracker_login_id, loopback_days,
                 recovery_dates_dynamic_variables_report_stream, recovery_dates_registration_report_stream,
                 is_recovery) -> None:
    ...
    def create_source_payload(self, name, airbyte_workspace_id):
        return {
            ...
            "name": name,
            "sourceName": Cellxpert.source_name,
            "sourceDefinitionId": Cellxpert.source_definition_id,
