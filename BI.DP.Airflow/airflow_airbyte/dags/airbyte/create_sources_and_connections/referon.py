...
class Referon:
    source_name = Variable.get('referon_sourceName'),
    source_definition_id = Variable.get('referon_source_definationid')
    ...
    def create_source_payload(self, name, airbyte_workspace_id):
        return {
            ...
            "name": name,
            "sourceName": Referon.source_name,
            "sourceDefinitionId": Referon.source_definition_id,
