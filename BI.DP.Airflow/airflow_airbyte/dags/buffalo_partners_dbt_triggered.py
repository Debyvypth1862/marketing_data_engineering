...
platform_name = "Buffalo Partners"
working_dir = "/opt/airflow/dags/dbt/buffalo_partner/buffalo_partner"
task_group_and_task_ids = []
no_of_tasks = 2
dag_id = "BuffaloPartnersDbtTriggered"
reprocess_dag_id = "ReprocessBuffaloPartnersExecuteAllOperatorAccounts"
...
with DAG(
    ...
    start = BashOperator(
        task_id="start",
        bash_command='echo "Starting Buffalo Partners DBT DAG..."',
    )
    ...
    start >> buffalo_partners_dbt_group >> Jira_create >> end >> branch_task
