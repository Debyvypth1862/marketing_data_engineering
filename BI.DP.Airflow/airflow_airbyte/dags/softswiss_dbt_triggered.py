...
working_dir = "/opt/airflow/dags/dbt/softswiss/softswiss"
task_group_and_task_ids = []
no_of_tasks = 2
dag_id = "SoftSwissDbtTriggered"
reprocess_dag_id = "ReprocessSoftswissExecuteAllOperatorAccounts"
...
with DAG(
    ...
    start = BashOperator(
        task_id="start",
        bash_command='echo "Starting SoftSwiss DBT DAG..."',
    )
    ...
    start >> softswiss_dbt_group >> Jira_create >> end >> branch_task
