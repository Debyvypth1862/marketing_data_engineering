...
platform_name = "Cellxpert"
working_dir = "/opt/airflow/dags/dbt/cellxpert/cellxpert"
task_group_and_task_ids = []
no_of_tasks = 2
dag_id = "CellxpertDbtTriggered"
reprocess_dag_id = "ReprocessCellxpertExecuteAllOperatorAccounts"
...
with DAG(
    ...
    for i in range(no_of_tasks):
        ...
        task_group_and_task_ids.append(f'{platform_name}_DBT.{stage}')
    ...
    trigger_reprocess_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="ReprocessCellxpertExecuteAllOperatorAccounts",
    ...
    start >> cellxpert_dbt_group >> Jira_create >> end >> branch_task
