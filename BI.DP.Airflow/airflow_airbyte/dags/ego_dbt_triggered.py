...
no_of_tasks = 2
dag_id = "EgoDbtTriggered"
reprocess_dag_id = "ReprocessEgoExecuteAllOperatorAccounts"
...
with DAG(
    ...
    start = BashOperator(
        task_id="start",
        bash_command='echo "Starting Ego DBT DAG..."',
    )
    ...
    trigger_reprocess_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="ReprocessEgoExecuteAllOperatorAccounts",
    ...
    start >> ego_dbt_group >> Jira_create >> end >> branch_task
