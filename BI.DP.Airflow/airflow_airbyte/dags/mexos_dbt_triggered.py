...
platform_name = "Mexos"
working_dir = "/opt/airflow/dags/dbt/mexos/mexos"
task_group_and_task_ids = []
no_of_tasks = 2
dag_id = "MexosDbtTriggered"
reprocess_dag_id = "ReprocessMexosExecuteAllOperatorAccounts"
...
with DAG(
    ...
    start = BashOperator(
        task_id="start",
        bash_command='echo "Starting Mexos DBT DAG..."',
    )
    ...
    start >> mexos_dbt_group >> Jira_create >> end >> branch_task
