...
platform_name = "MyAffiliates"
working_dir = "/opt/airflow/dags/dbt/myaffiliates/myaffiliates"
task_group_and_task_ids = []
no_of_tasks = 2
dag_id = "MyAffiliatesDbtTriggered"
reprocess_dag_id = "ReprocessMyAffiliatesExecuteAllOperatorAccounts"
...
with DAG(
    ...
    start = BashOperator(
        task_id="start",
        bash_command='echo "Starting MyAffiliates DBT DAG..."',
    )
    ...
    start >> myaffiliates_dbt_group >> Jira_create >> end >> branch_task
