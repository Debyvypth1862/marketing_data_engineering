...
platform_name = "Smartico"
working_dir = "/opt/airflow/dags/dbt/smartico/smartico"
task_group_and_task_ids = []
no_of_tasks = 2
dag_id = "SmarticoDbtTriggered"
reprocess_dag_id = "ReprocessSmarticoExecuteAllOperatorAccounts"
...
with DAG(
    ...
    start = BashOperator(
        task_id="start",
        bash_command='echo "Starting Smartico DBT DAG..."',
    )
    ...
    start >> smartico_dbt_group >> Jira_create >> end >> branch_task
