...
platform_name = "NetRefer"
working_dir = "/opt/airflow/dags/dbt/netrefer/netrefer"
task_group_and_task_ids = []
no_of_tasks = 2
dag_id = "NetreferDbtTriggered"
reprocess_dag_id = "ReprocessNetreferExecuteAllOperatorAccounts"
...
with DAG(
    ...
    start = BashOperator(
        task_id="start",
        bash_command='echo "Starting NetRefer DBT DAG..."',
    )
    ...
    start >> netrefer_dbt_group >> Jira_create >> end >> branch_task
