...
platform_name = "ReferON"
working_dir = "/opt/airflow/dags/dbt/referon/referon"
task_group_and_task_ids = []
no_of_tasks = 2
dag_id = "ReferonDbtTriggered"
reprocess_dag_id = "ReprocessReferonExecuteAllOperatorAccounts"
...
with DAG(
    ...
    start = BashOperator(
        task_id="start",
        bash_command='echo "Starting ReferON DBT DAG..."',
    )
    ...
    start >> referon_dbt_group >> Jira_create >> end >> branch_task
