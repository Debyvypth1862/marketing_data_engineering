...
platform_name = "Q"
working_dir = "/opt/airflow/dags/dbt/q_platform/q_platform"
task_group_and_task_ids = []
no_of_tasks = 2
dag_id = "QDbtTriggered"
reprocess_dag_id = "ReprocessQExecuteAllOperatorAccounts"
...
with DAG(
    ...
    start = BashOperator(
        task_id="start",
        bash_command='echo "Starting Q DBT DAG..."',
    )
    ...
    start >> q_dbt_group >> Jira_create >> end >> branch_task
